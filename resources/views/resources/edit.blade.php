            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('resources.resource.edit.submit', ['resource' => $resource->id]) }}" method="post">
                        ...
                        <textarea id="editor" name="description">{!! $resource->description !!}</textarea>
...
@section('custom-scripts')
    ...
    <script src="https://cdn.ckeditor.com/ckeditor5/35.4.0/super-build/translations/ru.js"></script>
    <script>
